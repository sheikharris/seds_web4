...
class achievements(models.Model):
    title=models.CharField(max_length=150,default='150 words max')
    img_link=models.CharField(max_length=500,default='500 words link max')
    summary=models.TextField(max_length=500,default='500 words max')
    date=models.DateField()
    myside=models.CharField(max_length=50,default='badge')
    def __str__(self):
        return self.title
