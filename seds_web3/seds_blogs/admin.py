...
from .models import blog,categories,Trending_blog,video_categories,vlog,vlog_trending,Astrophotography_trending,Astrophotography,categories_Astrophotography,achievements
...
class achievements_show(admin.ModelAdmin):
        list_display=[
        'title',
        'date'
        ]
...
admin.site.register(achievements,achievements_show)
