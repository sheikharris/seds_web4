...
from .models import blog,categories,Trending_blog,vlog,video_categories,vlog_trending,Astrophotography_trending,Astrophotography,categories_Astrophotography,achievements
...
def achievement(request):
      content=achievements.objects.all()
      side=[]
      i=1
      for j in content:
          if i%2==1:
      ...
      return render(request,"achievements.html",dist)
